  ...
  for(int i=0;i<iterations;i++){
    ...
    for(int x=0;x<(i+1);x++){
      ...
      if((i+1) % 2 == 1){
        ...
        if(x==0){
          if(HighlightEvens && nnOdd.get(x).mod(BIG2) == BigInteger.ZERO){
            fill(ORANGE);
          }
        ...
        //IF x IS GREATER THAN 0, THEN WE ARE NOT DEALING WITH ROW 1
          ...
          if(HighlightEvens && nnOdd.get(i-x+1).mod(BIG2) == BigInteger.ZERO){
            fill(ORANGE);
          }
      ...
      //EVEN ROWS (STARTING FROM ROW TWO) 
        ...
        if(x< ((i+1)/2)){
          ...
          if(HighlightEvens && nnEven.get(x).mod(BIG2) == BigInteger.ZERO){
            fill(ORANGE);
          }
          ...
          if(HighlightEvens && nnEven.get(i-x).mod(BIG2) == BigInteger.ZERO){
            fill(ORANGE);
          }
